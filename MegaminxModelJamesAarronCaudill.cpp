...
void baseMegaminx() {
	white = {0, 1, 2, 3, 4, 5, {0,5,1}, {0,1}, {0,1,2}, {0,5}, {0,2}, {0,4,5}, {0,2,3}, {0,4}, {0,3}, {0,3,4}}
	blue = {1, 0, 5, 9 ,10, 2, {1,2,0}, {1,0}, {1,0,5}, {1,2}, {1,5}, {1,9,2}, {1,5,10}, {1,9}, {1,10}, {1,10,9}}
	yellow = {2, 0, 1, 10 ,11, 3, {2,3,0}, {2,0}, {2,0,1}, {2,3}, {2,1}, {2,8,3}, {2,1,9}, {2,8}, {2,9}, {2,9,8}}
  purple = {3, 0, 2, 11 ,7, 4, {3,4,0}, {3,0}, {3,0,2}, {3,4}, {3,2}, {3,7,4}, {3,2,8}, {3,7}, {3,8}, {3,8,7}}
	green = {4, 0, 3, 7 ,8, 5, {4,5,0}, {4,0}, {4,0,3}, {4,5}, {4,3}, {4,11,5}, {4,3,7}, {4,11}, {4,7}, {4,7,11}}
	red = {5, 0, 4, 8, 9, 1, {5,1,0}, {5,0}, {5,0,4}, {5,1}, {5,4}, {5,10,1}, {5,4,11}, {5,10}, {5,11}, {5,11,10}}
  grey = {6, 7, 8, 9, 10, 11, {6,11,7}, {6,7}, {6,7,8}, {6,11}, {6,8}, {6,10,11}, {6,8,9}, {6,10}, {6,9}, {6,9,10}}
	lBlue = {7, 6, 11, 4, 3, 8, {7,8,6}, {7,6}, {7,6,11}, {7,8}, {7,11}, {7,3,8}, {7,11,4}, {7,3}, {7,4}, {7,4,3}}
	orange = {8, 6, 7, 3, 2, 9, {8,9,6}, {8,6}, {8,6,7}, {8,9}, {8,7}, {8,2,9}, {8,7,3}, {8,2}, {8,3}, {8,3,2}}
  lGreen = {9, 6, 8, 2, 1, 10, {9,10,6}, {9,6}, {9,6,8}, {9,10}, {9,8}, {9,1,10}, {9,8,2}, {9,1}, {9,2}, {9,2,1}}
  pink = {10, 6, 9, 1, 5, 11, {10,11,6}, {10,6}, {10,6,9}, {10,11}, {10,8}, {10,5,11}, {10,9,1}, {10,5}, {10,1}, {10,1,5}}
	lYellow = {11, 6, 10, 5, 4, 7, {11,7,6}, {11,6}, {11,6,10}, {11,7}, {11,10}, {11,4,7}, {11,10,5}, {11,4}, {11,5}, {11,5,4}}
...
void printSide(int color) {
	...
	printE = {colorName.bottomMiddle[0], colorName.bottomRightMiddle[0], colorName.topRightMiddle[0], colorName.topLeftMiddle[0], colorName.bottomLeftMiddle[0]};
	printC = {colorName.bottomRight[0], colorName.topRight[0], colorName.top[0], colorName.topLeft[0], colorName.bototmLeft[0]};
	printS = {colorName.bottomColor, colorName.bottomRightColor, colorName.topRightColor, colorName.topLeftColor, colorName.bottomLeftColor};
	center = colorName.centerColor;
	...
	*/
	...
	cout << " "; CPr(printS[3]); cout << "    "; CPr(printC[2]); cout << "    "; CPr(printS[2]); cout << endl;
        ...
        CPr(printS[4]); cout << " "; CPr(printE[4]); cout << "   "; CPr(rSide->colour); cout << "   "; CPr(printE[1]); cout << " "; CPr(printS[1]); cout << endl;
